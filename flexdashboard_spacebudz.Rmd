...
X[, market  := factor(market, levels = c("spacebudz.io", "jpg.store"))]
...
ggplot(X, aes(x_label, N, fill = market, alpha = data_when)) +
  ...
  scale_fill_manual(values = c("spacebudz.io" = "steelblue3", "jpg.store" = "steelblue4")) +
